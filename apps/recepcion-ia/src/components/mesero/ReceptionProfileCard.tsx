...
const DEFAULT_GREETING =
  "¡Bienvenido! Puedo ayudarte con check-in, tours, productos del hotel, amenidades y reservas.";

export function ReceptionProfileCard({
  assistantName,
  lastAssistantText,
  onClearConversation,
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-start justify-between gap-2">
          <div>
            ...
            <p className="text-[11px] text-mesero-text-muted/75">Tu recepcionista con IA</p>
          </div>
          {onClearConversation ? (
            <button
              type="button"
