      ...
      <div className="w-full max-w-md rounded-2xl border border-mesero-line/20 bg-mesero-panel/80 p-8 shadow-xl ring-1 ring-mesero-line/15 backdrop-blur-sm">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={busy}
            className="w-full rounded-xl bg-gradient-to-r from-mesero-accent to-teal-600 py-3 text-sm font-semibold text-white shadow-lg shadow-mesero-accent/25 hover:opacity-95 disabled:opacity-50"
          >
